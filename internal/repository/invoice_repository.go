...
import (
	...
	func (r *InvoiceRepository) Save(invoice *domain.Invoice) error {
		_, err := r.db.Exec( `INSERT INTO invoices (id, account_id, amount, status, description, payment_type, card_last_digits, created_at, updated_at)
...
//FindByAccountID busca todas as faturas associadas a uma conta
